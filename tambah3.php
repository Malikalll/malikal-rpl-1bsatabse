...
<div class="mb-3">
  ...
  <input class="form-check-input" type="radio" name="role" id="siswa" value="siswa">
...
<div class="form-check">
  <input class="form-check-input" type="radio" name="role" id="guru" value="guru" checked>
